...
public class VaccineManagementSystem {
    ...
    try {
        ...
        if (record.getDosesAdministered() >= selectedVaccine.getRequiredDoses()) {
            ...
            VMSDatabase.ensureVaccineRecordsTableExists();
    ...
    public void patientRecords(PatientDetails patient) {
        ...
        try {
            ...
            List<VaccineRecord> vaccineRecords = vaccineRecordDAO.getVaccineRecordsByPatientId(patient.getPatientID());
    ...
    public void displayAllPatients() {
        ...
        for (PatientDetails patient : children) {
            System.out.println("Patient ID: " + patient.getPatientID() + ", Name: " + patient.getFirstName() + " " + patient.getLastName());
        }
    
        for (PatientDetails patient : teens) {
            System.out.println("Patient ID: " + patient.getPatientID() + ", Name: " + patient.getFirstName() + " " + patient.getLastName());
        }
    
        for (PatientDetails patient : adults) {
            System.out.println("Patient ID: " + patient.getPatientID() + ", Name: " + patient.getFirstName() + " " + patient.getLastName());
        }
